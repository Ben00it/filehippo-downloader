...
#
#------If you need -> Debug Mode (Filehippo URL Structure can change) :  ----
#               set -x
#
#############################################################################
#            -       Set_Var         -                                      #
...
DESTINATION_DOWNLOAD="/mnt/download/"

# This file log errors
ERROR_FILE="filehippo_downloader_errors.log"

# This file donwload apps which are containning into 
DOWNLOAD_APPS="filehippo_downloader_apps.txt"

# Uncomment if you have email configured :
#EMAIL_RECIPIENT="mail1@domain.com mail2@domain.com"
...
#echo "Check url donwloading: $FETCH_URL"
...
#Step 1 - We're reading filehippo_downloader_apps.txt , then launch funtion
        while read SOFTWARE
                do
                # Reset Variables
...
# Step 7 -  Show program in error
cat $ERROR_FILE

# Step 8 - If ERROR.LOG isn't find then send email report
# Uncomment Only if you have a mail configured
